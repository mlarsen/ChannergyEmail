...
Module Module1
    ...
    'Public stPath As String = "E:\Core\DesignFurnishings\WayFairTest"
        ...
        If stSMTPCredentials(0) <> "NoData" Then
            ...
            For Each dr In ds.Tables("SendRecords").Rows
                Try
                    ...
                    Dim mailMsg As MailMessage = HtmlEmail.GetMailMessage()
    ...
    Sub LoadEmailHtmlBatch(ByRef stEmailSQL As String)
        ...
        stSQL = "SELECT FromEmailAddress,FromName,ReplyEmailAddress,Subject,BlindCarbonCopy,CarbonCopy,GroupByField,EmailAddressField,IsUpdateContactLog,CustNoField,OrderNoField FROM EmailHtml WHERE EmailName='" + stEmailName + "';"
        SQLTextQuery("S", stSQL, stODBCString, 11)
